...
template<class D_PRES, int NN>
HPD<D_PRES, NN> operator+( const HPD<D_PRES, NN>& lhs, const HPD<D_PRES, NN>& rhs )
{
	HPD<D_PRES, NN> ret;
...
template<class D_PRES, int NN>
HPD<D_PRES, NN> operator+( const D_PRES& lhs, const HPD<D_PRES, NN>& rhs )
{
	HPD<D_PRES, NN> ret;
...
template<class D_PRES, int NN>
HPD<D_PRES, NN> operator+( const HPD<D_PRES, NN>& lhs, const D_PRES& rhs )
{
	HPD<D_PRES, NN> ret;
...
public:
	...
	friend HPD operator+<>( const HPD& lhs, const HPD& rhs );
	//friend HPD operator+<>( const D_PRES& lhs, const HPD& rhs );
	//friend HPD operator+<>( const HPD& lhs, const D_PRES& rhs );
